...
public class HouseKeeper extends TableImpl<HouseKeeperRecord> {
    ...
    private static final long serialVersionUID = 1606367226;
     ...
     */
    public final TableField<HouseKeeperRecord, String> ID = createField("id", org.jooq.impl.SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>public.house_keeper.first_name</code>.
     */
    public final TableField<HouseKeeperRecord, String> FIRST_NAME = createField("first_name", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.house_keeper.last_name</code>.
     */
    public final TableField<HouseKeeperRecord, String> LAST_NAME = createField("last_name", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.house_keeper.age</code>.
     */
    public final TableField<HouseKeeperRecord, Integer> AGE = createField("age", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.house_keeper.level</code>.
     */
    public final TableField<HouseKeeperRecord, Integer> LEVEL = createField("level", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.house_keeper.status</code>.
     */
    public final TableField<HouseKeeperRecord, String> STATUS = createField("status", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).defaultValue(org.jooq.impl.DSL.field("'ACTIVE'::character varying", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
